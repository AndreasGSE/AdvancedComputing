...
# testFrame <- data.frame(first = c(1,2,3,4), second = c(0.4, -0.2, 0.2, 0),
#                         third = c(10, 11, 13, 10), target = c(1,0,1,2))
# testTest <- data.frame(first = c(2,1,4,3), second = c(-0.4, 0.2, -0.2, 0),
#                        third = c(11, 13, 11, 10))
# form <- as.formula("target~.")
# 
# cTree(form, testFrame, testFrame, 5, minPoints = 2)
